...
public class AgentU {
	...
	public void makeDecision() {
		...
		this.setDecision( ((uniqueness * value / maxSums) > this.threshold) ? 1 : 0 );
		// debugging
		//System.out.println("uniqueness:" + uniqueness + " value:" + value + " threshold:" + threshold + " uniqueness*value:" + (uniqueness*value) + " decision:" + decision);
//		// test
//		System.out.println("***AgentU.makeDecision()***(threshold: "+threshold+")");
//		System.out.println("uniqueness: "+uniqueness+" , value: "+value+
//				" , score: "+uniqueness*value/maxSums+" , decision: "+decision);
//		System.out.println("***");
//		// end test
	}
